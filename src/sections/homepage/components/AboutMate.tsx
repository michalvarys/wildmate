import { Button, Center, chakra, Container, Heading, VStack } from '@chakra-ui/react'

export function AboutMate({ transition }) {
  return (
    <chakra.div>
      <Button colorScheme="whiteAlpha" variant="link" onClick={() => transition(1)}>zpět</Button>
      <Container color="white">
        <VStack as={Center} spacing={4}>
          <Heading size="lg" color="yellow.400">Co je to Maté?</Heading>
          <chakra.p>
          ...
          <Heading size="lg" color="yellow.400">Jak se připravuje Maté?</Heading>
          <chakra.p>
          ...
          <Heading size="lg" color="yellow.400">Jaké jsou přínosy Maté pro zdraví?</Heading>
          <chakra.p>
